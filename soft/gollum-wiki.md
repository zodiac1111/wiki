...
* 或者从源码编译 [[这里(1.92)](http://www.shiftedbytes.com/2011/04/install-ruby-192-passenger-on-centos-55.html)]
* 和 [这里(1.92)](https://github.com/imeyer/ruby-1.9.2-rpm)(ruby1.9.2) **gollum现在版本需要高版本的ruby**
